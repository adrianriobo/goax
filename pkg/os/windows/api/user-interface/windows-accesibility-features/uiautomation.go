...
func ElementFromHandle(hwnd syscall.Handle) (element *wa.IUIAutomationElement, err error) {
	return elementFromHandle(manager, hwnd)
}
...
//	  );
func elementFromHandle(auto *wa.IUIAutomation, hwnd syscall.Handle) (element *wa.IUIAutomationElement, err error) {
...
//	  );
func GetCurrentControlType(elem *wa.IUIAutomationElement) (name int, err error) {
